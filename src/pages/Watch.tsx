                    ...
                    <div className="flex justify-between mt-1">
                      ...
                      <div className="flex items-center gap-4 uppercase">
                        <div className="flex items-center gap-1 cursor-pointer ">
                          <IconComponent icon={BiLike} classes={"text-xl"} />
                          <p>{currentPlaying.videoLikes}</p>
                        </div>
                        <div className="flex items-center gap-1 cursor-pointer">
                          <IconComponent icon={BiDislike} classes={"text-xl"} />

                          <p>dislike</p>
                        </div>
                        <div className="flex items-center gap-1 cursor-pointer">
                          <IconComponent icon={FaShare} classes={"text-xl"} />
                          <p>share</p>
                        </div>
                        <div className="flex items-center gap-1 cursor-pointer">
                          <IconComponent
